    ...
    return (
      <div className={classes.root}>
        ...
        <ul className={classes.list}>
          ...
          <img src={directoryManager2} alt="directoryManager new page example" className={classes.image}/>
          ...
          <img src={directoryManager3} alt="directoryManager expand example" className={classes.image}/>
          ...
          <img src={directoryManager4} alt="directoryManager navigation example" className={classes.image}/>
        </ul>
